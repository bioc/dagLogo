...
an alignment of multiple peptide sequences against background sequences. Compared to 
webLogo[@Crooks2004], which relies on information theory, IceLogo builds on probability theory. It is
...
### Case 3: You already have the unaligned peptides sequences in hand. Then you can use the formatSequence function to prepare an object of dagPeptides. Before doing that, you need prepare a Proteome object by the prepareProteome function.
...
## Step 3: Testing differential usage of (grouped) amino acid usage (DAG)
